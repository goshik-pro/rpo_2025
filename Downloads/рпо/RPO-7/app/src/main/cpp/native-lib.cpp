...
Java_org_ui3_fclient_MainActivity_stringFromJNI(JNIEnv* env, jobject /* this */) {
...
Java_org_ui3_fclient_MainActivity_initRng(JNIEnv *env, jobject thiz) {
...
Java_org_ui3_fclient_MainActivity_randomBytes(JNIEnv *env, jclass clazz, jint no) {
...
extern "C"
JNIEXPORT jbyteArray JNICALL
Java_org_ui3_fclient_MainActivity_encrypt(JNIEnv *env, jclass clazz, jbyteArray key,
                                          jbyteArray data) {
...
extern "C"
JNIEXPORT jbyteArray JNICALL
Java_org_ui3_fclient_MainActivity_decrypt(JNIEnv *env, jclass clazz, jbyteArray key,
                                          jbyteArray data) {
    jsize ksz = env->GetArrayLength(key);
    jsize dsz = env->GetArrayLength(data);
...
Java_org_ui3_fclient_MainActivity_transaction(JNIEnv *xenv, jobject xthiz, jbyteArray xtrd) {
